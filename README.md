# React Shoping Cart using React
...
1. `git clone https://github.com/AmirhosseinAbazari/ShopingCart`
...
The project is using the <strong>Fake Store API</strong>. All configurations are located in `package.json`, inside the `jest` object.
